#ifndef GAR_RECOALG_KD_TREE_ALGO_H
#define GAR_RECOALG_KD_TREE_ALGO_H
    ...
    namespace rec {
        namespace alg {
            ...
            */
            ...
            template <typename DATA, unsigned DIM>
            inline void KDTreeLinkerAlgo<DATA, DIM>::findNearestNeighbour(const KDTreeNodeInfoT<DATA, DIM> &point, const KDTreeNodeInfoT<DATA, DIM> *&result, float &distance)
            {
            ...
            template <typename DATA, unsigned DIM>
            inline void KDTreeLinkerAlgo<DATA, DIM>::recNearestNeighbour(unsigned int depth, const KDTreeNodeT<DATA, DIM> *current, const KDTreeNodeInfoT<DATA, DIM> &point, const KDTreeNodeT<DATA, DIM> *&best_match, float &best_dist)
            {
...
#endif // GAR_RECOALG_KD_TREE_ALGO_H
