...
//
// Copied from StructuredTree_module.cc on 2020 Dec 18 by C. Hilgenberg
////////////////////////////////////////////////////////////////////////////////
...
void gar::StructuredTree::beginJob() {
    ...
    if (fWriteMCPTrajectory) {
        ...
        // later code in StructuredTree::process etc.
        if (!fWriteMCinfo) {
...
//==============================================================================
void gar::StructuredTree::FillGeneratorMonteCarloInfo(art::Event const & e) {
    ...
    if (fGeneratorLabels.size()<1) {
        ...
        for (size_t i=0; i< fGeneratorLabels.size(); ++i) {
            ...
            if (!e.getByLabel(fGeneratorLabels.at(i),mcthandlelist.at(i))) {
                throw cet::exception("StructuredTree") << " No simb::MCTruth branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
        }
    }
    ...
    if (fGENIEGeneratorLabels.size()<1) {
        ...
        for (size_t i=0; i< fGENIEGeneratorLabels.size(); ++i) {
            ...
            if (!e.getByLabel(fGENIEGeneratorLabels.at(i),gthandlelist.at(i))) {
                throw cet::exception("StructuredTree") << " No simb::GTruth branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
        }
    }
    ...
    if (!e.getByLabel(fGeantLabel, MCPHandle)) {
        throw cet::exception("StructuredTree") << " No simb::MCParticle branch."
        << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
    }
    ...
    for (; iMCParticle<nMCParticles; ++iMCParticle) {
        ...
        if (fWriteMCCaloInfo) {
            if (!e.getByLabel(ecalgeanttag, SimHitHandle)) {
                throw cet::exception("StructuredTree") << " No gar::sdp::CaloDeposit branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
    ...
    void gar::StructuredTree::FillRawInfo(art::Event const & e) {
        ...
        if (!e.getByLabel(ecalrawtag, RawHitHandle)) {
            throw cet::exception("StructuredTree") << " No :raw::CaloRawDigit branch."
            << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
        }
    ...
    void gar::StructuredTree::FillRecoInfo(art::Event const & e) {

        // Get handle for TPC hit data
        art::Handle< std::vector<rec::Hit> > HitHandle;
        if (fWriteHits) {
            if (!e.getByLabel(fHitLabel, HitHandle)) {
                throw cet::exception("StructuredTree") << " No rec::Hit branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
        ...
        if (fWriteCaloHits) {
            ...
            if (!e.getByLabel(ecalrecotag, RecoHitHandle)) {
                throw cet::exception("StructuredTree") << " No rec::CaloHit branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
    ...
    void gar::StructuredTree::FillHighLevelRecoInfo(art::Event const & e) {
        ...
        if (fWriteTPCClusters) {
            if (!e.getByLabel(fTPCClusterLabel, TPCClusterHandle)) {
                throw cet::exception("StructuredTree") << " No rec::TPCCluster branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
        }
        ...
        if(fWriteTracks) {
            if (!e.getByLabel(fTrackLabel, TrackHandle)) {
                throw cet::exception("StructuredTree") << " No rec::Track branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
            if (!e.getByLabel(fTrackLabel, TrackIonHandle)) {
                throw cet::exception("StructuredTree") << " No rec::TrackIoniz branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
        ...
        if (fWriteVertices) {
            if (!e.getByLabel(fVertexLabel, VertexHandle)) {
                throw cet::exception("StructuredTree") << " No rec::Vertex branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
        ...
        if (fWriteVees) {
            if (!e.getByLabel(fVeeLabel, VeeHandle)) {
                throw cet::exception("StructuredTree") << " No rec::Vee branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
        ...
        if (fWriteCaloClusters) {
            if (!e.getByLabel(fClusterLabel, RecoClusterHandle)) {
                throw cet::exception("StructuredTree") << " No rec::Cluster branch."
                << " Line " << __LINE__ << " in file " << __FILE__ << std::endl;
            }
            if (fWriteTracks) {
        ...
        if (fWriteTPCClusters) {
            ...
            return;
        } // end :StructuredTree::FillVectors
        ...
        float gar::StructuredTree::processOneDirection(std::vector<std::pair<float,float>> SigData, float ionizeTruncate) {
        ...
        float gar::StructuredTree::computeT( simb::MCTruth theMCTruth ) {
        ...
        //==============================================================================
        //==============================================================================
        std::vector< std::pair<int, float> > gar::StructuredTree::processPIDInfo( float p )
        {
