/**
 * @file   garsoft/utilities/geo_vectors.h
...
#ifndef GARSOFT_UTILITIES_GEO_VECTORS_H
#define GARSOFT_UTILITIES_GEO_VECTORS_H
...
/**
 * @brief GArSoft geometry interface.
 * @see `geo::GeometryCore`
 * 
 * The `geo` namespace includes all GArSoft data types, classes and functions
 * related to detector geometry.
 * 
 * For more guidance, dee the @ref Geometry "GArSoft geometry module".
 */
namespace geo {
  ...
  /// @{
  /**
   * @name Vector types for the standard GArSoft geometry.
   * 
   * GArSoft geometry provides two main types of vectors in 3D space:
   * 
...
#endif // GARSOFT_UTILITIES_GEO_VECTORS_H
