...
namespace gar {
    namespace geo {
        ...
        BitFieldValue::BitFieldValue( const std::string& fieldName, unsigned fieldOffset, int signedWidth )
        : _mask(0), _offset( fieldOffset ), _width( abs( signedWidth ) ), _minVal(0), _maxVal(0), _isSigned( signedWidth < 0 ), _name( fieldName )
        {
            // sanity check
