#ifndef SEGMENTATIONMUIDALG_H
#define SEGMENTATIONMUIDALG_H
...
namespace gar {
    namespace geo {
        namespace seg {
            ...
            class SegmentationMuIDAlg: public SegmentationAlg {
            ...
            public:
                ...
                void setStripSizeY(double stripSize) { _stripSizeY = stripSize; _stripSizeX = stripSize; }
