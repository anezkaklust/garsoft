...
int main(int argc, char** argv) {
  ...
  << timer.elapsed()
  << " s ("
  << timer.elapsed<std::micro>()
  << " us); partial time: "
  << timer.partial<std::micro>()
  << " us"
  << std::endl;
  ...
  << " us); partial time: "
  << timer.partial<std::chrono::microseconds>()
  << " us"
  << std::endl;
  ...
  << " s); partial time: "
  << timer.partial<std::chrono::seconds>()
  << " s"
  << std::endl;
  ...
  << " ms); partial time: "
  << timer.partial<std::chrono::milliseconds>()
  << " ms"
  << std::endl;
