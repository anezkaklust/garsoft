...
//------------------------------------------------------------------------------
struct MyProvider: protected gar::UncopiableAndUnmovableClass {};
...
BOOST_AUTO_TEST_CASE(providerFromTest) {
   ...
   BOOST_CHECK_EXCEPTION(gar::providerFrom<MyService>(), art::Exception,
   ...
   BOOST_CHECK_EQUAL(gar::providerFrom<MyService>(), &prov);
